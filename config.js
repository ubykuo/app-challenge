...
if (process.env.NODE_ENV === "local") config.spotify.redirect_uri = "http://localhost:"+ config.port + "/api/auth/";
else config.spotify.redirect_uri = "http://app-challenge.herokuapp.com/api/auth/";
